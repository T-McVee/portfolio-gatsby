...
export default function HeaderLower({ contactMethods }: HeaderLowerProps) {
  return (
    <div className="relative z-[5] flex justify-end w-full h-56 pt-6">
      ...
      <SocialIcons
        ...
        wrapperClass="relative z-[5] flex flex-col items-end w-12 h-2/3 justify-around"
